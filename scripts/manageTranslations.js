/* tslint:disable */
/* eslint-disable */
const DEFAULT_LANGUAGE = 'ru'; // for the default language, everything is automatically whitelisted
const LANGUAGES = ['en', 'ru', 'uk']; // translations to generate---don't include the default language
const TARGET_DIRECTORY = 'src/external/i18n/translations';
